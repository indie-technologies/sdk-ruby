...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("temporal/api/taskqueue/v1/message.proto", :syntax => :proto3) do
    ...
    add_message "temporal.api.taskqueue.v1.CompatibleVersionSet" do
      repeated :build_ids, :string, 1
    end
    add_message "temporal.api.taskqueue.v1.TaskQueueReachability" do
      optional :task_queue, :string, 1
      repeated :reachability, :enum, 2, "temporal.api.enums.v1.TaskReachability"
    end
    add_message "temporal.api.taskqueue.v1.BuildIdReachability" do
      optional :build_id, :string, 1
      repeated :task_queue_reachability, :message, 2, "temporal.api.taskqueue.v1.TaskQueueReachability"
    end
  end
end
